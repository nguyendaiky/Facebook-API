...
for index in range(len(Input.values)):
    ...
    url = Input.values[index][0]
    access_token = Input.values[index][1]

    # GENERAL
    levelInput = "ad"
    fieldInput = ["account_name","campaign_id","campaign_name","adset_id","adset_name","ad_id","ad_name","spend","account_currency","reach","cpp","impressions","cpm","clicks","cpc","frequency","date_start","date_stop"]
    date_presetInput = "last_30d"
